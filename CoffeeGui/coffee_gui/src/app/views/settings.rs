...
pub fn create(store: &mut Store) -> View {
    ...
    // add buttons
    let up_temp: Box<Button>            = Box::new(Button::new("▲".to_string(), 0, 36, 30, 16, 14, 0, 15, Event::new("[temp.click]", Some(vec!["up".to_string()])), &CONFIG)); 
    let dn_temp: Box<Button>            = Box::new(Button::new("▼".to_string(), 0, 54, 30, 16, 14, 0, 15, Event::new("[temp.click]", Some(vec!["dn".to_string()])), &CONFIG)); 
    ...
    // add p 
    let up_p: Box<Button>               = Box::new(Button::new("▲".to_string(), 0, 90, 30, 16, 14, 0, 15, Event::new("[p.click]", Some(vec!["up".to_string()])), &CONFIG)); 
    let dn_p: Box<Button>               = Box::new(Button::new("▼".to_string(), 0, 111, 30, 16, 14, 0, 15, Event::new("[p.click]", Some(vec!["dn".to_string()])), &CONFIG)); 
    ...
    // add i
    let up_i: Box<Button>               = Box::new(Button::new("▲".to_string(), 0, 140, 30, 16, 14, 0, 15, Event::new("[i.click]", Some(vec!["up".to_string()])), &CONFIG)); 
    let dn_i: Box<Button>               = Box::new(Button::new("▼".to_string(), 0, 161, 30, 16, 14, 0, 15, Event::new("[i.click]", Some(vec!["dn".to_string()])), &CONFIG)); 
    ...
    // add d
    let up_d: Box<Button>               = Box::new(Button::new("▲".to_string(), 0, 190, 30, 16, 14, 0, 15, Event::new("[d.click]", Some(vec!["up".to_string()])), &CONFIG)); 
    let dn_d: Box<Button>               = Box::new(Button::new("▼".to_string(), 0, 211, 30, 16, 14, 0, 15, Event::new("[d.click]", Some(vec!["dn".to_string()])), &CONFIG)); 
